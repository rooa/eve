...
class Eve(Optimizer):
    ...
    def __init__(self, lr=0.001, beta_1=0.9, beta_2=0.999, beta_3=0.999,
                 c=10., epsilon=1e-8, decay=0., loss_min=0., **kwargs):
    ...
    def get_updates(self, params, constraints, loss):
        ...
        d_tilde_t = K.clip((d_num_t + self.fmin_pos) / (d_den_t + self.fmin_pos),
                           1./self.c, self.c)
